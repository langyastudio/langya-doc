...
![](https://img-note.langyastudio.com/202207031910434.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031910487.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031910833.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031910383.png?x-oss-process=style/watermark)

如此也就印证了之前的查询结果了。

再次写一条 SQL 查询 str1 字段：`SELECT * FROM`test1`WHERE str1 = 1234;`

![](https://img-note.langyastudio.com/202207031910454.png?x-oss-process=style/watermark)
