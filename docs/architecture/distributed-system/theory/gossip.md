...
![](https://img-note.langyastudio.com/202207031823723.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031823096.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031824949.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202207031824374.png?x-oss-process=style/watermark)

在我们实际应用场景中，一般不会采用随机的节点进行反熵，而是需要可以的设计一个闭环。这样的话，我们能够在一个确定的时间范围内实现各个节点数据的最终一致性，而不是基于随机的概率。像 InfluxDB 就是这样来实现反熵的。

![](https://img-note.langyastudio.com/202207031824172.png?x-oss-process=style/watermark)
...
![Gossip 传播示意图](https://img-note.langyastudio.com/202207031824472.gif?x-oss-process=style/watermark)

伪代码如下：

![](https://img-note.langyastudio.com/202207031824728.png?x-oss-process=style/watermark)
