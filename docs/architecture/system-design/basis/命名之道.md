...
![](https://img-note.langyastudio.com/202111171114454.png?x-oss-process=style/watermark)

这个句话实际上也是老马引用别人的，类似的表达还有很多。比如分布式系统领域有两大最难的事情：一是 **保证消息顺序** ，一是 **严格一次传递** 。

![](https://img-note.langyastudio.com/202111171114587.png?x-oss-process=style/watermark)
...
![](https://img-note.langyastudio.com/202111171120037.png?x-oss-process=style/watermark)
...
1、为了能让命名更加**易懂和易读**，尽量不要缩写/简写单词，除非这些单词已经被公认可以被这样缩写/简写。比如 `CustomThreadFactory` 不可以被写成 ~~`CustomTF` 
...
![](https://img-note.langyastudio.com/202111171143592.png?x-oss-process=style/watermark)

并且，Codelf 还提供了 VS code 插件，看这个评价，看来大家还是很喜欢这款命名工具的。

![](https://img-note.langyastudio.com/202111171143572.png?x-oss-process=style/watermark)
