...
![图片](https://img-note.langyastudio.com/202303031839146.png?x-oss-process=style/watermark)
...
如果你想导出一百万以上的数据，excel的一个sheet肯定是存放不下的。![图片](https://img-note.langyastudio.com/202303031858351.png?x-oss-process=style/watermark)

因此我们需要把数据保存到多个sheet中。![图片](https://img-note.langyastudio.com/202303031858843.png?x-oss-process=style/watermark)
...
如果是使用mq导数据：![图片](https://img-note.langyastudio.com/202303031858349.png?x-oss-process=style/watermark)

如果是使用job导数据：![图片](https://img-note.langyastudio.com/202303031858058.png?x-oss-process=style/watermark)
...
[100000行级别数据的 Excel 导入优化之路](https://mp.weixin.qq.com/s/teHAbU-1UpXdTJW_vx_z3Q)